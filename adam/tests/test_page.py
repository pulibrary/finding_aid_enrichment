...
test_canvas = Canvas(
    {
        "@type": "sc:Canvas",
        "@id": "https://figgy.princeton.edu/concern/scanned_resources/6a83801b-9169-40a4-8ca7-1494c94727b9/manifest/canvas/84304756-8e12-4a21-aad1-ba6d67582266",
        "label": "1",
        "rendering": [
            {
                "@id": "https://figgy.princeton.edu/downloads/84304756-8e12-4a21-aad1-ba6d67582266/file/45b6c33b-2b1c-4307-bb6c-a897e2a49e8c",
        ...
        "images": [
            {
                ...
                "resource": {
                    "@type": "dctypes:Image",
                    "@id": "https://iiif-cloud.princeton.edu/iiif/2/ad%2F7d%2F1b%2Fad7d1b2e62604a2aa1976ad8dbd21ba9%2Fintermediate_file/full/1000,/0/default.jpg",
                    "height": 4770,
                    "width": 3774,
                    "format": "image/jpeg",
                    "service": {
                        "@context": "http://iiif.io/api/image/2/context.json",
                        "@id": "https://iiif-cloud.princeton.edu/iiif/2/ad%2F7d%2F1b%2Fad7d1b2e62604a2aa1976ad8dbd21ba9%2Fintermediate_file",
                        "profile": "http://iiif.io/api/image/2/level2.json",
                    },
                },
                "@id": "https://figgy.princeton.edu/concern/scanned_resources/6a83801b-9169-40a4-8ca7-1494c94727b9/manifest/image/84304756-8e12-4a21-aad1-ba6d67582266",
                "on": "https://figgy.princeton.edu/concern/scanned_resources/6a83801b-9169-40a4-8ca7-1494c94727b9/manifest/canvas/84304756-8e12-4a21-aad1-ba6d67582266",
            }
        ],
    }
)

test_canvas_2 = Canvas(
    {
        "@type": "sc:Canvas",
...
def fixture_basic_page():
    return Page(test_canvas, {"Container": ["Box 53, Folder 18 to 19"]})


@pytest.fixture(name="page_with_ocr")
def fixture_ocr_page():
    return Page(test_canvas_2)


def test_id(basic_page):
    assert (
        basic_page.id
        == "https://figgy.princeton.edu/concern/scanned_resources/6a83801b-9169-40a4-8ca7-1494c94727b9/manifest/canvas/84304756-8e12-4a21-aad1-ba6d67582266"
    )
...
def test_get_rendering(page_with_ocr):
    assert page_with_ocr.text[0:8] == "Kennan P"
